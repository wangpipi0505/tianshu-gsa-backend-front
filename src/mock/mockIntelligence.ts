...
export const MOCK_EVIDENCE_ITEMS: EvidenceItem[] = [
  {
    ...
    recordedTime: '2026-08-25 14:22:15',
    confidenceScore: 0.94,
    payloadSummary: '由机载光电侦察吊舱在14:22提取，目标长19.2m、双发后掠翼，尾喷口红外热斑温度达540℃，置信度0.94',
  ...
  },
  {
    ...
    category: 'radar_data',
    sourceType: '雷达特征观测',
    datasetVersion: 'v3.1.2',
    recordedTime: '2026-08-25 14:22:10',
    confidenceScore: 0.91,
    payloadSummary: '雷达特征库中历史机型Alpha在X波段正向RCS均值为0.025m²，当前侧向机动探测RCS为2.8m²，符合该机动特征谱',
  ...
  },
  {
    ...
    recordedTime: '2026-08-25 10:15:00',
    confidenceScore: 0.88,
    payloadSummary: '情报通报显示该联队于24日进驻前沿基地，出动批次常包含两机编队伴随加油机开展超视距远海战备巡逻',
  ...
  },
  {
    ...
    recordedTime: '2026-08-25 14:21:48',
    confidenceScore: 0.96,
    payloadSummary: '捕获到该机火控雷达在14:21进行短时截获脉冲，频点与历史战役记录中的APG-81型雷达高度重合',
  ...
  },
  {
    ...
    category: 'c2_data',
    sourceType: '数据链与AIS校验',
    datasetVersion: 'v1.1.0',
    recordedTime: '2026-08-25 15:20:00',
    confidenceScore: 0.99,
    payloadSummary: 'PLAN-DDG-163 焦作舰通过北斗/卫通专网持续回传阿曼湾商船编队安全护航坐标与 346A相控阵雷达空海监视状态',
  ...
  },
  {
    ...
    category: 'radar_data',
    sourceType: '雷达特征观测',
    datasetVersion: 'v2.0.1',
    recordedTime: '2026-08-25 15:18:30',
    confidenceScore: 0.95,
    payloadSummary: '波斯湾外军预警机与突防战机编队（FALCON-01 + RAVEN-03）时空航迹与 X波段火控信号被多站点连续测向锁定',
  ...
  },
  {
    ...
    category: 'elint_data',
    sourceType: '电子侦察截获',
    datasetVersion: 'v1.0.3',
    recordedTime: '2026-08-25 15:10:00',
    confidenceScore: 0.97,
    payloadSummary: '拦截到海峡北岸山地阵位防空多功能相控阵制导雷达常态化开机信号，覆盖海峡咽喉水道全部海空空域',
